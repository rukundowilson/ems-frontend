      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className="bg-white py-20 px-4 sm:px-6 lg:px-12">
          <div className="max-w-xl space-y-8">
            ...
            {/* CTA Button */}
            <div>
              <Link href="/services" className="btn-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition-colors duration-200 flex items-center gap-3">
                Get started
